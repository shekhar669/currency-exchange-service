...
import com.nos.microservices.currencyexchangeservice.parallel.call.CountryClientAsync;

public class CountryClientTest {
	private CountryClientAsync
	countryClient;

	@BeforeEach
    public void setUp() {
        countryClient = Mockito.spy(new CountryClientAsync());
    }
